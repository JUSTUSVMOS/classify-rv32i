...
inner_loop_end:
    ...
    # Move to next row in A and reset column pointer for B
    slli t1, a2, 2        # Calculate offset in bytes for next row of A
    add s3, s3, t1    # Increment pointer in A to next row
    addi s0, s0, 1       # Increment outer row counter
    j outer_loop_start
